...
export default function ProfileScreen({navigation}){
    ...
    return( 
        ...
        <View style={{borderRadius: 100, overflow: "hidden", marginBottom: "5%"}}>
          <Image source={profile.profilePhoto}/>
        </View>
        <Text style={{fontWeight: "bold", marginRight: "65%", fontSize: 18}}>
          Username
        </Text>
        <TextInput value={newUsername} onChangeText={onUsernameChange} style= {styles.textInContainer}/>
        <Text  style={{fontWeight: "bold", marginRight: "70%", fontSize: 18}}>
          E-mail
        </Text>
        <TextInput value={newMail} onChangeText={onMailChange} style= {styles.textInContainer}/>
        <Text  style={{fontWeight: "bold", marginRight: "50%", fontSize: 18}}>
          Supported Team
        </Text>
        <TextInput value={newTeam} onChangeText={onTeamChange} style= {styles.textInContainer}/>
        <View style={{flexDirection: "row"}}>
        <Button title="Save Changes" onPress={saveChanges} style={{marginRight:100}}/>
